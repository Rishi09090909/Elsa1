...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>To get movie/series please send movie name in our group this bot provide movie in group .

Group link:- https://t.me/+N_YurZVkTsE4MzQ1
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴏᴡɴ ɪɴғᴏ', url='https://t.me/Rk_botz')
        ], [
        ...
        buttons = [[
           ...
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/Rk_botz')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='aswin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
